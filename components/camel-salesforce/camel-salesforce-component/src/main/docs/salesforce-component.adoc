...
| *etCdRepoCacheDepth* (common) | 1 |  | String
| *etcdRepoPassword* (common) | 1 |  | String
| *etcdRepoPlaceholderValue* (common) | 1 |  | String
| *etcdRepoUri* (common) | 1 |  | String
| *etcdRepoUsername* (common) | 1 |  | String
